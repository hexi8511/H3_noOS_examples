...
ssize_t console_stdin_read( unsigned char * buf, size_t size)
{
return 0;
}


ssize_t console_stdin_write( unsigned char * buf, size_t size)
{
return 0;
}


ssize_t console_stderr_write( unsigned char * buf, size_t size)
{
return 0;
}
