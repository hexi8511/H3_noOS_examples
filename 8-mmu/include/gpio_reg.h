...
#define PC_CFG0 (PIO_BASE_ADDR+0x24+0x00)
#define PC_CFG1 (PIO_BASE_ADDR+0x24+0x04)
#define PC_CFG2 (PIO_BASE_ADDR+0x24+0x08)
#define PC_CFG3 (PIO_BASE_ADDR+0x24+0x0c)
#define PC_DAT 	(PIO_BASE_ADDR+0x24+0x10)
#define PC_DRV0 (PIO_BASE_ADDR+0x24+0x14)
#define PC_DRV1 (PIO_BASE_ADDR+0x24+0x18)
#define PC_PUL0 (PIO_BASE_ADDR+0x24+0x1c)
#define PC_PUL1 (PIO_BASE_ADDR+0x24+0x20)

#define PD_CFG0 (PIO_BASE_ADDR+0x24*2+0x00)
#define PD_CFG1 (PIO_BASE_ADDR+0x24*2+0x04)
#define PD_CFG2 (PIO_BASE_ADDR+0x24*2+0x08)
#define PD_CFG3 (PIO_BASE_ADDR+0x24*2+0x0c)
#define PD_DAT 	(PIO_BASE_ADDR+0x24*2+0x10)
#define PD_DRV0 (PIO_BASE_ADDR+0x24*2+0x14)
#define PD_DRV1 (PIO_BASE_ADDR+0x24*2+0x18)
#define PD_PUL0 (PIO_BASE_ADDR+0x24*2+0x1c)
#define PD_PUL1 (PIO_BASE_ADDR+0x24*2+0x20)

#define PE_CFG0 (PIO_BASE_ADDR+0x24*3+0x00)
#define PE_CFG1 (PIO_BASE_ADDR+0x24*3+0x04)
#define PE_CFG2 (PIO_BASE_ADDR+0x24*3+0x08)
#define PE_CFG3 (PIO_BASE_ADDR+0x24*3+0x0c)
#define PE_DAT 	(PIO_BASE_ADDR+0x24*3+0x10)
#define PE_DRV0 (PIO_BASE_ADDR+0x24*3+0x14)
#define PE_DRV1 (PIO_BASE_ADDR+0x24*3+0x18)
#define PE_PUL0 (PIO_BASE_ADDR+0x24*3+0x1c)
#define PE_PUL1 (PIO_BASE_ADDR+0x24*3+0x20)

#define PF_CFG0 (PIO_BASE_ADDR+0x24*4+0x00)
#define PF_CFG1 (PIO_BASE_ADDR+0x24*4+0x04)
#define PF_CFG2 (PIO_BASE_ADDR+0x24*4+0x08)
#define PF_CFG3 (PIO_BASE_ADDR+0x24*4+0x0c)
#define PF_DAT 	(PIO_BASE_ADDR+0x24*4+0x10)
#define PF_DRV0 (PIO_BASE_ADDR+0x24*4+0x14)
#define PF_DRV1 (PIO_BASE_ADDR+0x24*4+0x18)
#define PF_PUL0 (PIO_BASE_ADDR+0x24*4+0x1c)
#define PF_PUL1 (PIO_BASE_ADDR+0x24*4+0x20)

#define PG_CFG0 (PIO_BASE_ADDR+0x24*5+0x00)
#define PG_CFG1 (PIO_BASE_ADDR+0x24*5+0x04)
#define PG_CFG2 (PIO_BASE_ADDR+0x24*5+0x08)
#define PG_CFG3 (PIO_BASE_ADDR+0x24*5+0x0c)
#define PG_DAT 	(PIO_BASE_ADDR+0x24*5+0x10)
#define PG_DRV0 (PIO_BASE_ADDR+0x24*5+0x14)
#define PG_DRV1 (PIO_BASE_ADDR+0x24*5+0x18)
#define PG_PUL0 (PIO_BASE_ADDR+0x24*5+0x1c)
#define PG_PUL1 (PIO_BASE_ADDR+0x24*5+0x20)
#if 0
