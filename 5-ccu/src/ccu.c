...
void open_apb0_clk()
{
printf("[%s] APB0 frequency setting\n",__func__);
...
void sys_clk_init()
{
	...
	//set pll frequency
	if(0!=pll_set_out_freq(PLL_TYPE_CPUX,1008000000))//1.008G
		{
		printf("set cpux pll error!\n");
		return ;
		}

	if(0!=pll_set_out_freq(PLL_TYPE_PERIPH0,600000000))//600M
		{
		printf("set periph0 pll error!\n");
		return ;
		}

	if(0!=pll_set_out_freq(PLL_TYPE_DDR,408000000))
		{
	...
	if(0!=pll_set_out_freq(PLL_TYPE_VIDEO,594000000))
		{
